...
<?php if( $is_cowebop_base )jma_content_top(); ?>
    ...
    if( $is_cowebop_base ) {
        ...
        $use_title = $jma_spec_options['title_page_top'] != 1 || $jma_spec_options['body_shape'] == 'dark_modular'  || !is_single();
    }
	if ( ! themeblvd_get_att('epic_thumb') && ! has_post_format('quote') && $use_title ) : ?>
